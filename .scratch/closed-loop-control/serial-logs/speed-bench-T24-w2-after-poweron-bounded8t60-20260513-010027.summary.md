...
- Feedforward: `0.02`
- Raw log: `/Volumes/[C] Windows 11/Users/jjp/Documents/Keil-work/AI_Vision_RT1064/.scratch/closed-loop-control/serial-logs/speed-bench-T24-w2-after-poweron-bounded8t60-20260513-010027.log`

| Step | Command | Targets | Samples | dt min/mean/max ms | Measured mm/s | Duty % | Saturation | Conclusion |
| ---- | ------- | ------- | ------- | ------------------ | ------------- | ------ | ---------- | ---------- |
| `w2_100` | `speed wheel 2 100` | `0,100,0,0` | 132 | 5/5.0/5 | w2: mean=0.0 min=0.0 max=0.0 | w2: mean=11.6 min=0.0 max=15.0 | w2:0% | CHECK w2:SIGN_CHECK, w2:WEAK_RESPONSE |
...
| `w2_200` | `speed wheel 2 200` | `0,200,0,0` | 131 | 5/5.0/5 | w2: mean=0.0 min=0.0 max=0.0 | w2: mean=23.6 min=17.1 max=30.0 | w2:0% | CHECK w2:SIGN_CHECK, w2:WEAK_RESPONSE |
| `w2_200_stop` | `speed wheel 2 0` | `0,0,0,0` | 52 | 5/5.0/5 | w1: mean=0.0 min=0.0 max=0.0<br>w2: mean=0.0 min=0.0 max=0.0<br>w3: mean=0.0 min=0.0 max=0.0<br>w4: mean=0.0 min=0.0 max=0.0 | w1: mean=0.0 min=0.0 max=0.0<br>w2: mean=0.0 min=0.0 max=0.0<br>w3: mean=0.0 min=0.0 max=0.0<br>w4: mean=0.0 min=0.0 max=0.0 | w1:0%, w2:0%, w3:0%, w4:0% | PASS |
| `w2_-200` | `speed wheel 2 -200` | `0,-200,0,0` | 131 | 5/5.0/5 | w2: mean=-198.0 min=-414.1 max=-16.6 | w2: mean=-4.0 min=-13.1 max=6.8 | w2:0% | PASS |
